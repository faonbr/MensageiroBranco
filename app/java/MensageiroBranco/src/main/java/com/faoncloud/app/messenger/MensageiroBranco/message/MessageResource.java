...
public class MessageResource {
	 ...
	 */
	@GetMapping(path="/v1/clients/{clientId}/messages")
	 ...
	 * TODO: Need to validate the shared key as header before accepting the data.
	 */
	@GetMapping(path="/v1/clients/{clientId}/messages/unread")
	 ...
	 * TODO: Need to validate the shared key as header before accepting the data.
	 */
	@GetMapping(path="/v1/clients/{clientId}/messages/read")
	 ...
	 */
	@PostMapping(path="/v1/clients/{clientId}/messages")
